module.exports = {
	...
	async execute(bot, messageCreate, args, mainPrefix) {
		if(!args[0] || args[0] ==="here") return messageCreate.channel.send("https://jasbot.senghong.xyz")
		if(args[0] == "dm") return messageCreate.author.send("https://jasbot.senghong.xyz").catch((error) => {
			console.error(error)
			messageCreate.channel.send("https://jasbot.senghong.xyz")
